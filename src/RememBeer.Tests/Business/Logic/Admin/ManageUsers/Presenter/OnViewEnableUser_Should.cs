...
{
    [TestFixture]
    public class OnViewEnableUser_Should : TestClassBase
    {
        [Test]
        public void Call_UserServiceEnableUserMethodOnceWithCorrectParams()
        {
            ...
            userService.Setup(s => s.EnableUser(id))
            ...
            view.Raise(v => v.UserEnable += null, view.Object, args.Object);

            userService.Verify(s => s.EnableUser(id), Times.Once);
        }
