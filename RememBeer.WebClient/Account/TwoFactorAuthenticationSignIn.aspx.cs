...
namespace RememBeer.WebClient.Account
{
    public partial class TwoFactorAuthenticationSignIn : Page
    {
        ...
        protected void CodeSubmit_Click(object sender, EventArgs e)
        {
            ...
            var result = this.signinManager.TwoFactorSignIn<ApplicationUser, string>(this.SelectedProvider.Value, this.Code.Text, isPersistent: rememberMe, rememberBrowser: this.RememberBrowser.Checked);
            switch (result)
            {
