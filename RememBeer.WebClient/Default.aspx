...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <h1>Remem<i class="fa fa-beer fa-lg"></i>Me</h1>
       <p>So, you are sitting in <em>&lt;insert foreign country with great beers&gt;</em> having an ice-cold pint of <br/> <em>&lt;insert beer with a complicated name&gt;</em>. You really like it. 
