...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <uc:UserNotifications runat="server" ID="Notification"></uc:UserNotifications>
    <div class="container">
        <asp:GridView ID="UserGridView" runat="server"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Locked Until" AccessibleHeaderText="Locked Until">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="IdTb" CssClass="form-control" runat="server" Text='<%# Eval("LockoutEndDateUtc") %>' ReadOnly="True"></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
