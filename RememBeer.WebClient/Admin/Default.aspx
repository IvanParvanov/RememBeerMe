<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="RememBeer.WebClient.Admin.Admin" %>
        ...
        <asp:GridView
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Details">
                    <ItemTemplate>
                        <asp:HyperLink runat="server" CssClass="btn btn-primary" NavigateUrl='<%# "Brewery.aspx?id=" +  this.Eval("Id") %>'><i class="fa fa-link" aria-hidden="true"></i></asp:HyperLink>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
            <PagerSettings
